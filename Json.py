...
def detection2Json(Detection):
    msg = {}
    #msg["header"]           = header2Json(Detection.header)
    msg["relative_bearing"] = Detection.relative_bearing
    msg["right_detection"]  = Detection.right_detection
    return msg
...
def detInput2Detection(msg):
    det = Detection()
    det.relative_bearing    = msg["bearing"]
    det.right_detection     = msg["Detection"]
    return det
